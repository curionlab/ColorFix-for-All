...
export default function FileDropzone({ onFileSelect, accept = 'application/pdf,image/*' }: FileDropzoneProps) {
  ...
  return (
    <div 
      className={`border-2 border-dashed rounded-xl p-12 flex flex-col items-center justify-center transition-colors cursor-pointer text-center ${isDragOver ? 'border-emerald-500 bg-emerald-50' : 'border-slate-300 hover:border-emerald-400 bg-white'}`}
